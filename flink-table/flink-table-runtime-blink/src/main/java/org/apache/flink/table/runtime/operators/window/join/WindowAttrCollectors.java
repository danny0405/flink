...
public class WindowAttrCollectors {
	...
	public static class StartWindowAttrCollector implements WindowAttrCollector {
		private transient final GenericRowData reusedWindowAttrs = new GenericRowData(1);
		private transient final JoinedRowData reusedWrapperRow = new JoinedRowData();
	...
	public static class StartEndWindowAttrCollector implements WindowAttrCollector {
		private transient final GenericRowData reusedWindowAttrs = new GenericRowData(2);
		private transient final JoinedRowData reusedWrapperRow = new JoinedRowData();
