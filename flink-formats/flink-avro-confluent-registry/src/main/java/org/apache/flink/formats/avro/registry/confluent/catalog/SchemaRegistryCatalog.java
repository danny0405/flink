...
public class SchemaRegistryCatalog extends TableCatalog {
	...
	private SchemaRegistryCatalog(
		...
		validateForbiddenOptions(connectorOptions);

		Map<String, String> overriddenProps = new HashMap<>(connectorOptions);
		overriddenProps.put(FactoryUtil.CONNECTOR.key(), "kafka");
		this.connectorOptions = Collections.unmodifiableMap(overriddenProps);
	...
	private void validateForbiddenOptions(Map<String, String> connectorProps) {
	...
	public static class Builder {
		...
		public Builder kafkaOptions(Map<String, String> props) {
			...
			this.kafkaOptions = Collections.unmodifiableMap(props);
			return this;
		}
		...
		/** Sets up the catalog name, default is 'kafka'. */
