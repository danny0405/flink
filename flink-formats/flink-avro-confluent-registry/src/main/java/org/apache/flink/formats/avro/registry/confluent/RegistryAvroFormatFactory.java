...
import static org.apache.flink.formats.avro.registry.confluent.RegistryAvroOptions.SCHEMA_STRING;
...
public class RegistryAvroFormatFactory implements
	...
	public static final String IDENTIFIER = "avro-sr";
	...
	public DecodingFormat<DeserializationSchema<RowData>> createDecodingFormat(
		...
		String avroSchema = formatOptions.get(SCHEMA_STRING);
		...
		return new DecodingFormat<DeserializationSchema<RowData>>() {
			...
			public DeserializationSchema<RowData> createRuntimeDecoder(
				...
				return ConfluentRegistryAvroRowDataDeserializationSchema.create(
						avroSchema,
						schemaRegistryURL,
						rowType,
						rowDataTypeInfo);
	...
	public EncodingFormat<SerializationSchema<RowData>> createEncodingFormat(
		...
		return new EncodingFormat<SerializationSchema<RowData>>() {
			...
			public SerializationSchema<RowData> createRuntimeEncoder(
				...
				return ConfluentRegistryAvroRowDataSerializationSchema.create(
						subject.get(),
						avroSchema,
						schemaRegistryURL,
						rowType
